...
const images = [
  ...
  "/images/dashboard5.jpg",
];

export default function WebAppDashboardDevelopment() {
  const currentId = "web-app-dashboard-development";
  ...
  const items = [
    ...
    "Pemberitahuan dan alert system",
    "Pemeliharaan dan update berkala",
  ];

  const steps = [
    "Analisis Kebutuhan",
    "Desain Wireframe & Prototipe",
  ...
  return (
    <PageLayout
      ...
      subtitle="Powerful and scalable web applications tailored to visualize your data and streamline business operations."
    >
          ...
          <div className="md:col-span-2 space-y-10">
            ...
            <div>
              <h3 className="text-2xl text-black uppercase tracking-wide">
                What is Web App & Dashboard Development?
              </h3>
              <hr className="my-4 border-t-4 w-20 border-teal-600" />
              <p className="text-gray-700 leading-relaxed mb-3">
                Web App & Dashboard Development focuses on creating interactive,
                data-driven applications that empower businesses to make informed decisions.
                These custom-built dashboards visualize complex datasets in an intuitive way,
                helping users monitor performance and manage operations efficiently.
              </p>
              <p className="text-gray-700 leading-relaxed">
                By choosing tailored dashboard solutions, your business will get tools that
                fit exactly your workflows, with real-time updates, strong security, and seamless
          ...
          <div className="grid grid-cols-2 gap-4">
            {images.map((src, i) => (
              ...
              >
                <Image
                  src={src}
                  alt={`Dashboard Development Image ${i + 1}`}
                  width={300}
                  height={200}
